    ...
    return (
        <div>
            ...
            <section className="register-container">
                <div className="container px-6 py-24 h-full text-gray-800">
                            ...
                            <form method='POST' onSubmit={handleSubmit}>
                                ...
                                <div className="mb-6">
                                    <input
                                        type="text"
                                        name='name'
                                        className="form-control block w-full px-4 py-2 text-xl font-normal text-white bg-neutral-600 bg-clip-padding border-solid border-2 border-black rounded transition ease-in-out m-0 outline-none capitalize"
                                        placeholder="Name"
                                ...
                                <div className="text-center">
                                    <button
                                        ...
                                        <div className="relative inline-flex items-center justify-center p-4 px-5 py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out rounded-full shadow-xl group hover:ring-1 hover:ring-purple-500">
                                            ...
                                            <span className="relative text-white text-xl">Register</span>
                                        </div>
                                    </button>
